...
\begin{itemize}
\item Exponential-family structure in \(\theta\) $\Rightarrow$ SAEM with sufficient statistics and closed-form or low-dimensional M-step.
\item Nonlinear dependence of \(\theta\) inside variances, link functions, or constraints $\Rightarrow$ SAEM with numerical M-step.
