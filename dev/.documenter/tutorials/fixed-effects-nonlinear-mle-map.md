...
# Fixed-Effects Tutorial 1: Nonlinear Longitudinal Model (MLE + MAP) {#Fixed-Effects-Tutorial-1:-Nonlinear-Longitudinal-Model-MLE-MAP}
...
## Step 2: Define a Nonlinear Fixed-Effects Model {#Step-2:-Define-a-Nonlinear-Fixed-Effects-Model}
...
## Step 3: Build the DataModel and Configure Estimation {#Step-3:-Build-the-DataModel-and-Configure-Estimation}
...
## Step 4: Fit with MLE and MAP {#Step-4:-Fit-with-MLE-and-MAP}
...
## Step 5: Compare Parameter Estimates {#Step-5:-Compare-Parameter-Estimates}
...
## Step 6: Fitted Trajectories {#Step-6:-Fitted-Trajectories}
...
## Step 7: Observation Distribution Diagnostics {#Step-7:-Observation-Distribution-Diagnostics}
