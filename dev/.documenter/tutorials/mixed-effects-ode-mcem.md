...
# Mixed-Effects Tutorial 2: ODE Model with Input Events (MCEM) {#Mixed-Effects-Tutorial-2:-ODE-Model-with-Input-Events-MCEM}
...
## Step 1: Prepare the Event-Table {#Step-1:-Prepare-the-Event-Table}
...
## Step 2: Define the ODE Mixed-Effects Model {#Step-2:-Define-the-ODE-Mixed-Effects-Model}
...
## Step 3: Build the DataModel {#Step-3:-Build-the-DataModel}
...
## Step 4: Configure MCEM {#Step-4:-Configure-MCEM}
...
## Step 5: Fit the Model and Inspect Core Outputs {#Step-5:-Fit-the-Model-and-Inspect-Core-Outputs}
...
### FitResult Summary {#FitResult-Summary}
...
## Step 6: Visualize Fitted Trajectories {#Step-6:-Visualize-Fitted-Trajectories}
...
&lt;!– injected:t2-pfit –&gt; 
![](figures/t2/p_fit_mcem.png)


## Step 7: Assess the Observation Distribution {#Step-7:-Assess-the-Observation-Distribution}
...
&lt;!– injected:t2-pobs –&gt; 
![](figures/t2/p_obs_mcem.png)


## Step 8: Quantify Parameter Uncertainty {#Step-8:-Quantify-Parameter-Uncertainty}
