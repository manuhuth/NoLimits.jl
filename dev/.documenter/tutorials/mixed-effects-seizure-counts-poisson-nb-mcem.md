...
# Mixed-Effects Tutorial 5: Modeling Seizure Counts with Poisson and Negative Binomial Outcomes {#Mixed-Effects-Tutorial-5:-Modeling-Seizure-Counts-with-Poisson-and-Negative-Binomial-Outcomes}
...
## Step 2: Poisson Mixed-Effects Model {#Step-2:-Poisson-Mixed-Effects-Model}
...
### Build `DataModel` and Configure `MCEM` {#Build-DataModel-and-Configure-MCEM}
...
### Fit, Summarize, Plot, and UQ (Poisson) {#Fit,-Summarize,-Plot,-and-UQ-Poisson}
...
### Build `DataModel`, Fit, Summarize, Plot, and UQ (Negative Binomial) {#Build-DataModel,-Fit,-Summarize,-Plot,-and-UQ-Negative-Binomial}
...
&lt;!– injected:t5-puqnb –&gt; 
![](figures/t5/p_uq_nb.png)


## Step 4: Comparing Poisson and Negative Binomial Objectives {#Step-4:-Comparing-Poisson-and-Negative-Binomial-Objectives}
