...
If your outcome is a discrete observed-state Markov model with ambiguous/set-valued state labels, use `coarsed(...)` instead of `censored(...)`. See the formulas documentation: [`Example: Coarsed Observed-State Markov Model`](/model-building/formulas#example-coarsed-observed-state-markov-model).
...
## Step 2: Define the Nonlinear Left-Censored Mixed-Effects Model {#Step-2:-Define-the-Nonlinear-Left-Censored-Mixed-Effects-Model}
...
## Step 3: Build `DataModel` and Configure `Laplace` {#Step-3:-Build-DataModel-and-Configure-Laplace}
...
## Step 4: Fit and Inspect Core Summary {#Step-4:-Fit-and-Inspect-Core-Summary}
...
&lt;!– injected:t6-pfit –&gt; 
![](figures/t6/p_fit.png)


## Step 6: Observation Distribution Diagnostic (First Individual) {#Step-6:-Observation-Distribution-Diagnostic-First-Individual}
...
&lt;!– injected:t6-pobs –&gt; 
![](figures/t6/p_obs.png)


## Step 7: Wald Uncertainty Quantification {#Step-7:-Wald-Uncertainty-Quantification}
