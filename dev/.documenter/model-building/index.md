...
## What Can Be Composed {#What-Can-Be-Composed}
...
## Example: Multiple Outcomes and Grouping Structures {#Example:-Multiple-Outcomes-and-Grouping-Structures}
...
## Example: Learned Components in Random-Effect Distributions {#Example:-Learned-Components-in-Random-Effect-Distributions}
...
- [`@Model`](/model-building/model-macro#@Model) – Top-level macro and validation rules
  
- [`@helpers`](/model-building/helpers#@helpers) – Reusable helper functions
  
- [`@fixedEffects`](/model-building/fixed-effects#@fixedEffects) – Population-level parameter definitions
  
- [`@covariates`](/model-building/covariates#@covariates) – Covariate types and interpolation
  
- [`@randomEffects`](/model-building/random-effects#@randomEffects) – Random-effect distributions and grouping
  
- [`@preDifferentialEquation`](/model-building/pre-differential-equation#@preDifferentialEquation) – Time-constant derived quantities
  
- [`@DifferentialEquation`](/model-building/differential-equation#@DifferentialEquation) – ODE dynamics and derived signals
  
- [`@initialDE`](/model-building/initial-de#@initialDE) – Initial conditions for ODE states
  
- [`@formulas`](/model-building/formulas#@formulas) – Observation models and deterministic nodes
