...
## Available Bindings in Distribution Expressions {#Available-Bindings-in-Distribution-Expressions}
...
## Example: Multiple Grouping Structures {#Example:-Multiple-Grouping-Structures}
...
## Example: Covariate- and Function-Parameterized Distributions {#Example:-Covariate-and-Function-Parameterized-Distributions}
...
## Example: Normalizing Flow Random Effects {#Example:-Normalizing-Flow-Random-Effects}
...
## Metadata and Builder Accessors {#Metadata-and-Builder-Accessors}
...
## Grouping and Data Requirements {#Grouping-and-Data-Requirements}
...
## Row-Varying Group Membership Within an Individual {#Row-Varying-Group-Membership-Within-an-Individual}
