...
NoLimits provides parameter types for scalars, vectors, structured matrices, and learned function approximators. Each type controls how values are stored, transformed during optimization, and optionally regularized via priors. The overview below lists the purpose and value kind of each type; see the [Parameter Types](/api#Parameter-Types) section of the API reference for full constructor signatures, keyword arguments, and defaults.
...
## Example: Classical Parameter Blocks {#Example:-Classical-Parameter-Blocks}
...
## Transforms, Bounds, and Priors {#Transforms,-Bounds,-and-Priors}
...
## Example: Learned Function Approximators {#Example:-Learned-Function-Approximators}
...
## Example: Constrained Stochastic Matrices {#Example:-Constrained-Stochastic-Matrices}
...
## Example: Normalizing Flows for Flexible Random-Effect Distributions {#Example:-Normalizing-Flows-for-Flexible-Random-Effect-Distributions}
