...
## Example: Basic Initial State Builder {#Example:-Basic-Initial-State-Builder}
...
## Example: Using Helpers, preDE, and Model Functions {#Example:-Using-Helpers,-preDE,-and-Model-Functions}
...
## Example: Nonlinear Mixed-Effects ODE Initialization {#Example:-Nonlinear-Mixed-Effects-ODE-Initialization}
...
## Static Initial-State Variant {#Static-Initial-State-Variant}
