...
## Example: Standalone Helper Block {#Example:-Standalone-Helper-Block}
...
## Example: Helper in Formulas {#Example:-Helper-in-Formulas}
...
## Example: Helper in Random-Effect Distribution {#Example:-Helper-in-Random-Effect-Distribution}
...
## Note on Automatic Differentiation {#Note-on-Automatic-Differentiation}
