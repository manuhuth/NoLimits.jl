...
See the [Plotting and Diagnostics](/api#Plotting-and-Diagnostics) section of the API reference for the full list of functions and their arguments.
...
## Reusing computations with `build_plot_cache` {#Reusing-computations-with-build_plot_cache}
...
![](iyoykfa.png){width=1050px height=560px}
...
![](tlqwrsw.png){width=1050px height=560px}

## Multistart objective-value plot {#Multistart-objective-value-plot}
...
![](wthqteh.png){width=600px height=400px}

## Fitted trajectory comparison across models {#Fitted-trajectory-comparison-across-models}
...
![](wkdsqvb.png){width=700px height=300px}

## Multistart fixed-effect variability {#Multistart-fixed-effect-variability}
...
![](ukeefyr.png){width=900px height=300px}
...
![](dwtowsv.png){width=900px height=300px}

## Observation distribution diagnostic {#Observation-distribution-diagnostic}
...
![](amurdjf.png){width=400px height=300px}
...
## Residual QQ diagnostic {#Residual-QQ-diagnostic}
...
![](pnrsxuk.png){width=400px height=300px}
...
## Visual predictive check {#Visual-predictive-check}
...
![](bljpywq.png){width=400px height=300px}
...
## Random-effects distribution diagnostic {#Random-effects-distribution-diagnostic}
...
![](dveicsj.png){width=400px height=300px}

## Uncertainty quantification plot {#Uncertainty-quantification-plot}
...
![](frgltwy.png){width=1050px height=300px}
