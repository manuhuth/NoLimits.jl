...
### Wald (`method=:wald`) {#Wald-method:wald}
...
### Chain (`method=:chain`) {#Chain-method:chain}
...
### Profile (`method=:profile`) {#Profile-method:profile}
...
### MCMC Refit (`method=:mcmc_refit`) {#MCMC-Refit-method:mcmc_refit}
...
## Returned Object and Accessors {#Returned-Object-and-Accessors}
...
## Parameter Inclusion Rules {#Parameter-Inclusion-Rules}
