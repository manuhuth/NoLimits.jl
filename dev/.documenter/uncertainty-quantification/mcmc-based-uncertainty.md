...
# MCMC-Based Uncertainty {#MCMC-Based-Uncertainty}
...
## 1) Chain UQ (`method=:chain`) {#1-Chain-UQ-method:chain}
...
## 2) MCMC Refit UQ (`method=:mcmc_refit`) {#2-MCMC-Refit-UQ-method:mcmc_refit}
...
### How Parameters Are Selected for Refit {#How-Parameters-Are-Selected-for-Refit}
...
### Refit Method Configuration {#Refit-Method-Configuration}
