...
## Common Fit Keywords {#Common-Fit-Keywords}
...
## Multistart Wrapper {#Multistart-Wrapper}
...
## Example: Mixed-Effects Model Fitted with Multiple Methods {#Example:-Mixed-Effects-Model-Fitted-with-Multiple-Methods}
...
## Fixing Known Random-Effect Levels {#Fixing-Known-Random-Effect-Levels}
...
## Fixed-Effects-Only Path {#Fixed-Effects-Only-Path}
