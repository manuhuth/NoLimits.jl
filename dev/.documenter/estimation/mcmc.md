...
## Basic Usage (Mixed Effects, Nonlinear in Random Effects) {#Basic-Usage-Mixed-Effects,-Nonlinear-in-Random-Effects}
...
## Sampler-Dependent Defaults {#Sampler-Dependent-Defaults}
...
## Turing.jl Interface {#Turing.jl-Interface}
...
## Pattern: Fix Known Random-Effect Levels (`constants_re`) {#Pattern:-Fix-Known-Random-Effect-Levels-constants_re}
...
## Pattern: Sample Random Effects with All Fixed Effects Held Constant {#Pattern:-Sample-Random-Effects-with-All-Fixed-Effects-Held-Constant}
...
## Fixed-Effects-Only Example {#Fixed-Effects-Only-Example}
...
## HMM Example (Mixed Effects) {#HMM-Example-Mixed-Effects}
