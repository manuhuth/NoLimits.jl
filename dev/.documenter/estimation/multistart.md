...
- `screening` — Phase-1 screening criterion (see [Two-Phase Workflow](/estimation/multistart#two-phase-workflow)). `:prior_mean` (default) evaluates each candidate at η = 0; `:ebe` runs a short empirical-Bayes optimization (capped at `ebe_maxiters` iterations) before scoring.
...
### Screening and Method Direction {#Screening-and-Method-Direction}
...
## How Starts Are Built {#How-Starts-Are-Built}
...
## Requested vs. Used Draws {#Requested-vs.-Used-Draws}
...
## Scoring and Best-Run Selection {#Scoring-and-Best-Run-Selection}
...
## Parallelism and RNG Behavior {#Parallelism-and-RNG-Behavior}
...
## Fit Keyword Forwarding {#Fit-Keyword-Forwarding}
...
## Multistart Result Accessors {#Multistart-Result-Accessors}
...
## Example: Fixed-Effects MLE with Screening {#Example:-Fixed-Effects-MLE-with-Screening}
...
## Example: Variational Inference with Multistart {#Example:-Variational-Inference-with-Multistart}
...
## Optional: MCMC with Multistart (Supported, Usually Not Recommended) {#Optional:-MCMC-with-Multistart-Supported,-Usually-Not-Recommended}
