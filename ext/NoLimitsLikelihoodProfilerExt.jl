...
function _profile_profiler(profile_method::Symbol, profile_local_alg::Symbol,
...
function _profile_run(profiler, optprob, xhat, j::Int, scan_lo, scan_hi, threshold,
    ...
    return (; left = ep.left, right = ep.right,
